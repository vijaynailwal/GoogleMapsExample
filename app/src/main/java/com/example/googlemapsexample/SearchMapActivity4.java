...
public class SearchMapActivity4 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void geoLocate(){
        ...
        Geocoder geocoder = new Geocoder(SearchMapActivity4.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(SearchMapActivity4.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(SearchMapActivity4.this);
    }
